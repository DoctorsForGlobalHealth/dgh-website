 ...
 */
?>
<div class="view view-<?php print $css_name; ?> view-id-<?php print $name; ?> view-display-id-<?php print $display_id; ?> view-dom-id-<?php print $dom_id; ?> project-teaser" id="teaser-project-<?php print $node->nid ?>">
