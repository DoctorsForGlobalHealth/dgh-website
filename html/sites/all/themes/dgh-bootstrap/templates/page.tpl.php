 ...
 <div class="container">
   ...
   <?php if($topofpage) : ?>
    ...
    <div id="header" class="row">
      <div class="span12">
        <img src="<?php print $theme_path ?>/images/saying.gif" alt="promoting health and human rights with those who have no voice">
      </div>
    </div>
  
    <div id="page-wrapper" class="row">

      <div id="sidebar-col" class="span3">
        <a href="<?php print front_page ?>" alt="home"><img id="header-logo" src="<?php print $theme_path ?>/images/logo.gif" alt="logo"/></a>
        <br />
      ...
      <div id="content-col" class="span9">
    
        <div id="content-title-bar" class="row">
          <div class="span7">
            <a href="<?php print base_path() ?>" alt="home"><img id="header-name" src="<?php print $theme_path ?>/images/banner-name.gif" alt="Doctors for Global Health"/></a>
          </div>
          <div class="span2">
